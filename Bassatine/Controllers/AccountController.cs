...
namespace Bassatine.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            //Boolean _passwordchanged = false;

            //if (_passwordchanged == false)
            //{

            //    return RedirectToAction("rChangePassword", "Manage");
            //}
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    Member member = null;
                    member = MemberManager.GetMemberByLogin(model.Email); 
                    ...
                    if (member.PasswordChanged == false)
                    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    BassatineUsersManager _BassatineUserManager = new BassatineUsersManager();
                    _BassatineUserManager.UpdateVendorcodeBassatineUsers(user.Id, model.VendorCode, model.userisAdmin, model.userisActive,false);
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirm your account", "Please confirm your account by clicking <a href=\"" + callbackUrl + "\">here</a><br/><br/>Email : " + user.Email + "< br/>Password : " + model.Password);
        ...
        // GET: /Account/Register
        [AllowAnonymous]
        public ActionResult bassatineusers()
        {
            return View();
        }
